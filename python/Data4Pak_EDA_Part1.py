...
# %%
data = pd.read_csv("Data4Pakistan-AllData.csv")
...
# %%
dataManip1.to_csv(r'C:\Users\sabahat iqbal\Dropbox\Continuing Ed\Clean-up and EDA with Python\updatedData.csv', index = False, header=True)
